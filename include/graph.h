...
{
public:
    Edge (int id, double w, double r, double f, Node *dest);
...
public:
	...
	int entrada;        // Entrada == 1; Saída == 0
	double radius;      // Radius of the segment (edge)  /*EU*/
	double flow;
	double velocity;    // Velocity on that edge /*EU*/
};
...
public:
	...
	double velocity;        // Velocity of the cell
};
// =============================================================================================================
// =============================================================================================================
...
private:
	...
	void insertEdgeGraph (int id_1, int id_2, int entrada,  /*EU*/ double radius, double flow);
// 	void insertPMJ ();
